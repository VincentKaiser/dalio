(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && (e.target.closest(".icon-menu") || e.target.closest(".burger-menu__close"))) {
                bodyLockToggle();
    ...
    function initSliders() {
        if (document.querySelector(".slider-services")) new core(".slider-services", {
            modules: [ Navigation, Pagination ],
            spaceBetween: 17,
            speed: 800,
            pagination: {
                el: ".slider-services-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-services-button-prev",
                nextEl: ".slider-services-button-next"
            },
            on: {}
        });
        if (document.querySelector(".slider-projects")) new core(".slider-projects", {
            modules: [ Navigation, Pagination ],
            slidesPerView: 2,
            spaceBetween: 32,
            autoHeight: true,
            ...
            navigation: {
                prevEl: ".slider-projects-button-prev",
                nextEl: ".slider-projects-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".slider-testimonials")) new core(".slider-testimonials", {
            ...
            speed: 800,
            pagination: {
                el: ".slider-testimonials-pagination",
                clickable: true
            },
            navigation: {
        ...
        if (document.querySelector(".slider-blog")) new core(".slider-blog", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    da.init();
    const ourProjectsBtn = document.querySelector(".main-btn-1");
    const ourWorksBtn = document.querySelector(".main-btn-2");
    window.addEventListener("DOMContentLoaded", (function(e) {
        if (this.document.body.clientWidth >= 480) {
            ourProjectsBtn.classList.add("_active");
            ourWorksBtn.classList.remove("_active");
        } else if (this.document.body.clientWidth < 480) {
            ourProjectsBtn.classList.remove("_active");
            ourWorksBtn.classList.add("_active");
        }
    }));
    ...
    window.addEventListener("DOMContentLoaded", (function(e) {
        if (this.document.body.clientWidth >= 1201) titleLine.src = "img/main-block/background/curved-line.svg"; else if (this.document.body.clientWidth < 1201) titleLine.src = "img/main-block/background/curved-line-small.svg";
    }));
    window.addEventListener("resize", (function(e) {
        if (this.document.body.clientWidth >= 1201) titleLine.src = "img/main-block/background/curved-line.svg"; else if (this.document.body.clientWidth < 1201) titleLine.src = "img/main-block/background/curved-line-small.svg";
    }));
